...
public class Main {
    ...
    static short pageSizeValue = 64;
    static short fileFormatVersion = 1;
    ...
    public static Map<String, Object> parseHeader(byte[] db){
    ...
    static byte[] readXBytes(byte[] byteArray, int noOfBytes, int startIdx){
        return Arrays.copyOfRange(byteArray, startIdx, startIdx+noOfBytes);
    }

    private static byte[] getDBHeader() {
